...
class WPML_Elementor_Translatable_Nodes implements IWPML_Page_Builders_Translatable_Nodes {
	...
	public static function get_nodes_to_translate() {
		return array(
			...
			'imroz-tabs'   => array(
				'conditions'        => array( self::TYPE => 'imroz-tabs'),
				'fields'            => array(),
				'integration-class' => 'WPML_Elementor_imroz_tabs',
			),
			'imroz-gallery'   => array(
				'conditions'        => array( self::TYPE => 'imroz-gallery'),
				'fields'            => array(
					array(
						'field'       => 'rbt_gallery_before_title',
						'type'        => __( 'gallery before title', 'imroz' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'rbt_gallery_title',
						'type'        => __( 'gallery title', 'imroz' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'rbt_gallery_desctiption',
						'type'        => __( 'gallery desctiption', 'imroz' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'all_filter_label',
						'type'        => __( 'filter label', 'imroz' ),
						'editor_type' => 'LINE'
					),
				),
				'integration-class' => 'WPML_Elementor_imroz_gallery',
			),
			'imroz-list-style'   => array(
				'conditions'        => array( self::TYPE => 'imroz-list-style'),
				'fields'            => array(
					array(
						'field'       => 'rbt_list_style_before_title',
						'type'        => __( 'list before title', 'imroz' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'rbt_list_style_title',
						'type'        => __( 'list title', 'imroz' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'rbt_list_style_desctiption',
						'type'        => __( 'list description', 'imroz' ),
						'editor_type' => 'LINE'
					),
				),
				'integration-class' => 'WPML_Elementor_imroz_list_style',
			),
			'imroz-main-demo-banner'   => array(
				'conditions'        => array( self::TYPE => 'imroz-main-demo-banner'),
				'fields'            => array(
					array(
					...
					array(
						...
						'type'        => __( 'content description', 'imroz' ),
						'editor_type' => 'LINE'
					),
				),
				'integration-class' => 'WPML_Elementor_imroz_main_demo_banner',
			),
			'imroz-testimonial'   => array(
				'conditions'        => array( self::TYPE => 'imroz-testimonial'),
				'fields'            => array(),
				'integration-class' => 'WPML_Elementor_imroz_testimonial',
			),
			'imroz-progress-bar'   => array(
				'conditions'        => array( self::TYPE => 'imroz-progress-bar'),
				'fields'            => array(
					array(
						'field'       => 'rbt_progress_bar_before_title',
						'type'        => __( 'before title', 'imroz' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'rbt_progress_bar_title',
						'type'        => __( 'progress_bar title', 'imroz' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'rbt_progress_bar_desctiption',
						'type'        => __( 'progress_bar description', 'imroz' ),
						'editor_type' => 'LINE'
					),
				),
				'integration-class' => 'WPML_Elementor_imroz_progress_bar',
			),
			'imroz-pricing'   => array(
				'conditions'        => array( self::TYPE => 'imroz-pricing'),
				'fields'            => array(
					array(
						'field'       => 'rbt_pricing_before_title',
						'type'        => __( 'pricing before title', 'imroz' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'rbt_pricing_title',
						'type'        => __( 'pricing title', 'imroz' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'rbt_pricing_desctiption',
						'type'        => __( 'pricing description', 'imroz' ),
						'editor_type' => 'AREA'
					),
				),
				'integration-class' => 'WPML_Elementor_imroz_pricing',
			),
			'imroz-main-services'   => array(
				'conditions'        => array( self::TYPE => 'imroz-main-services'),
				'fields'            => array(
					array(
						'field'       => 'rbt_services_before_title',
						'type'        => __( 'service before title', 'imroz' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'rbt_services_title',
						'type'        => __( 'service title', 'imroz' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'rbt_services_desctiption',
						'type'        => __( 'service description', 'imroz' ),
						'editor_type' => 'AREA'
					),
					array(
						'field'       => 'rbt_services_button_text',
						'type'        => __( 'service btn text', 'imroz' ),
						'editor_type' => 'LINE'
					),
				),
				'integration-class' => 'WPML_Elementor_imroz_main_services',
			),
			'imroz-accordion'   => array(
				'conditions'        => array( self::TYPE => 'imroz-accordion'),
				'fields'            => array(),
				'integration-class' => 'WPML_Elementor_imroz_accordion',
			),
			'imroz-main-slider'   => array(
				'conditions'        => array( self::TYPE => 'imroz-main-slider'),
				'fields'            => array(),
				'integration-class' => 'WPML_Elementor_imroz_main_slider',
			),
			'imroz-about-with-experience'   => array(
				'conditions'        => array( self::TYPE => 'imroz-about-with-experience'),
				'fields'            => array(
					array(
				...
				'integration-class' => 'WPML_Elementor_imroz_about_with_experience',
			),
		);
	}
